...
var loc = [
	...
	["Srpski", "Istorija", "Program", "Program", "Engleski", "Inform", "Inform"],
	["Srpski", "Fizika", "Hemija", "Geografija", "OET", "Gradjasko"],
	["Fizika", "Fizicko", "Matematika", "Geografija", "Praksa", "Praksa", "Hemija"],
	["RacunarGraf", "RacunarGraf", "Istorija", "OET", "Matematika", "Srpski"]
]
...
function togglevisible(a:number, b:string[][]) {
    var element:any = "";    
    // za neradne dane
    if (a == 0 || a == 6) {
    ...
    if (b[a-1] != undefined) {
        if (b[a-1].length < 7) {
            element = document.getElementById("a7"); element.style.display = "none";
            element = document.getElementById("b7"); element.style.display = "none";
            element = document.getElementById("p7"); element.style.display = "none";
        } else {
            element = document.getElementById("a7"); element.style.display = "block";
            element = document.getElementById("b7"); element.style.display = "block";
            element = document.getElementById("p7"); element.style.display = "block";
        }
    }
}
